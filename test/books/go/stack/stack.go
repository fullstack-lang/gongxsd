...
import (
	...
	"github.com/fullstack-lang/gongxsd/test/books/go/fullstack"
	"github.com/fullstack-lang/gongxsd/test/books/go/models"
	"github.com/fullstack-lang/gongxsd/test/books/go/orm"
	"github.com/fullstack-lang/gongxsd/test/books/go/probe"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongxsd/test/books/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, books_go.GoModelsDir, books_go.GoDiagramsDir,
