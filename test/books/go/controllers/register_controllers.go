...
func registerControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		v1.GET("/v1/a_bookss", GetController().GetA_bookss)
		v1.GET("/v1/a_bookss/:id", GetController().GetA_books)
		v1.POST("/v1/a_bookss", GetController().PostA_books)
		v1.PATCH("/v1/a_bookss/:id", GetController().UpdateA_books)
		v1.PUT("/v1/a_bookss/:id", GetController().UpdateA_books)
		v1.DELETE("/v1/a_bookss/:id", GetController().DeleteA_books)
...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/fullstack-lang/gongxsd/test/books/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/fullstack-lang/gongxsd/test/books/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/fullstack-lang/gongxsd/test/books/go:\n",
		...
		parts := strings.Split("github.com/fullstack-lang/gongxsd/test/books/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
