...
import (
	...
	books_orm "github.com/fullstack-lang/gongxsd/test/books/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*books_orm.BackRepoStruct
}
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*books_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *books_orm.BackRepoStruct, stackPath string) {
