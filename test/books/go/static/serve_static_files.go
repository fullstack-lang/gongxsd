...
import (
	...
	"github.com/fullstack-lang/gongxsd/test/books"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(books.NgDistNg, "ng-github.com-fullstack-lang-gongxsd-test-books/dist/ng-github.com-fullstack-lang-gongxsd-test-books/browser")))
