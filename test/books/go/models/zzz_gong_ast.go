							...
							case *ast.SelectorExpr:
								...
								if Sel := slcExpr.Sel; Sel != nil {
									...
									case "BookType":
										...
										instanceBookType.Stage(stage)
										instance = any(instanceBookType)
										__gong__map_BookType[identifier] = instanceBookType
									case "Books":
										instanceBooks := new(Books)
										instanceBooks.Name = instanceName
										instanceBooks.Stage(stage)
										instance = any(instanceBooks)
										__gong__map_Books[identifier] = instanceBooks
									case "Credit":
										instanceCredit := new(Credit)
										instanceCredit.Name = instanceName
										instanceCredit.Stage(stage)
				...
				case *ast.Ident, *ast.SelectorExpr:
					...
					case "BookType":
						...
						case "Credit":
							...
							identifierOfInstanceToAppend := ident.Name
							if instanceToAppend, ok := __gong__map_Credit[identifierOfInstanceToAppend]; ok {
								instanceWhoseFieldIsAppended := __gong__map_BookType[identifier]
								instanceWhoseFieldIsAppended.Credit = append(instanceWhoseFieldIsAppended.Credit, instanceToAppend)
							}
						}
					case "Books":
						switch fieldName {
						...
						case "Book":
							...
							identifierOfInstanceToAppend := ident.Name
							if instanceToAppend, ok := __gong__map_BookType[identifierOfInstanceToAppend]; ok {
								instanceWhoseFieldIsAppended := __gong__map_Books[identifier]
								instanceWhoseFieldIsAppended.Book = append(instanceWhoseFieldIsAppended.Book, instanceToAppend)
							}
						}
					case "Credit":
						...
						case "Link":
							...
							if instanceToAppend, ok := __gong__map_Link[identifierOfInstanceToAppend]; ok {
								instanceWhoseFieldIsAppended := __gong__map_Credit[identifier]
								instanceWhoseFieldIsAppended.Link = append(instanceWhoseFieldIsAppended.Link, instanceToAppend)
							}
						}
					case "Link":
						switch fieldName {
		...
		case *ast.BasicLit, *ast.UnaryExpr, *ast.CompositeLit:
			...
			case "BookType":
				...
				case "Title":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_BookType[identifier].Title = fielValue
				case "Author":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_BookType[identifier].Author = fielValue
				case "Year":
					...
					__gong__map_BookType[identifier].Year = int(exprSign) * int(fielValue)
				case "Format":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
			...
			case "Credit":
				...
				case "Page":
					...
					__gong__map_Credit[identifier].Page = int(exprSign) * int(fielValue)
				case "Credit_type":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Credit[identifier].Credit_type = fielValue
				case "Credit_words":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
					__gong__map_Credit[identifier].Credit_words = fielValue
				case "Credit_symbol":
					// remove first and last char
					fielValue := basicLit.Value[1 : len(basicLit.Value)-1]
