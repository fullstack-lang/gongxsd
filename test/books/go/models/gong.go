...
type StageStruct struct {
	...
	BookDetailsGroups           map[*BookDetailsGroup]any
	BookDetailsGroups_mapString map[string]*BookDetailsGroup

	// insertion point for slice of pointers maps
	OnAfterBookDetailsGroupCreateCallback OnAfterCreateInterface[BookDetailsGroup]
	OnAfterBookDetailsGroupUpdateCallback OnAfterUpdateInterface[BookDetailsGroup]
	OnAfterBookDetailsGroupDeleteCallback OnAfterDeleteInterface[BookDetailsGroup]
	OnAfterBookDetailsGroupReadCallback   OnAfterReadInterface[BookDetailsGroup]
...
type BackRepoInterface interface {
	...
	CommitBookDetailsGroup(bookdetailsgroup *BookDetailsGroup)
	CheckoutBookDetailsGroup(bookdetailsgroup *BookDetailsGroup)
...
func NewStage(path string) (stage *StageStruct) {
	...
	stage = &StageStruct{ // insertion point for array initiatialisation
		BookDetailsGroups:           make(map[*BookDetailsGroup]any),
		BookDetailsGroups_mapString: make(map[string]*BookDetailsGroup),
...
// Stage puts bookdetailsgroup to the model stage
func (bookdetailsgroup *BookDetailsGroup) Stage(stage *StageStruct) *BookDetailsGroup {
	stage.BookDetailsGroups[bookdetailsgroup] = __member
	stage.BookDetailsGroups_mapString[bookdetailsgroup.Name] = bookdetailsgroup

	return bookdetailsgroup
}

// Unstage removes bookdetailsgroup off the model stage
func (bookdetailsgroup *BookDetailsGroup) Unstage(stage *StageStruct) *BookDetailsGroup {
	delete(stage.BookDetailsGroups, bookdetailsgroup)
	delete(stage.BookDetailsGroups_mapString, bookdetailsgroup.Name)
	return bookdetailsgroup
}

// UnstageVoid removes bookdetailsgroup off the model stage
func (bookdetailsgroup *BookDetailsGroup) UnstageVoid(stage *StageStruct) {
	delete(stage.BookDetailsGroups, bookdetailsgroup)
	delete(stage.BookDetailsGroups_mapString, bookdetailsgroup.Name)
}

// commit bookdetailsgroup to the back repo (if it is already staged)
func (bookdetailsgroup *BookDetailsGroup) Commit(stage *StageStruct) *BookDetailsGroup {
	if _, ok := stage.BookDetailsGroups[bookdetailsgroup]; ok {
		if stage.BackRepo != nil {
			stage.BackRepo.CommitBookDetailsGroup(bookdetailsgroup)
		}
	}
	return bookdetailsgroup
}

func (bookdetailsgroup *BookDetailsGroup) CommitVoid(stage *StageStruct) {
	bookdetailsgroup.Commit(stage)
}

// Checkout bookdetailsgroup to the back repo (if it is already staged)
func (bookdetailsgroup *BookDetailsGroup) Checkout(stage *StageStruct) *BookDetailsGroup {
	if _, ok := stage.BookDetailsGroups[bookdetailsgroup]; ok {
		if stage.BackRepo != nil {
			stage.BackRepo.CheckoutBookDetailsGroup(bookdetailsgroup)
		}
	}
	return bookdetailsgroup
}
...
func (bookdetailsgroup *BookDetailsGroup) GetName() (res string) {
	return bookdetailsgroup.Name
}
...
func (stage *StageStruct) Reset() { // insertion point for array reset
	stage.BookDetailsGroups = make(map[*BookDetailsGroup]any)
	stage.BookDetailsGroups_mapString = make(map[string]*BookDetailsGroup)
...
func (stage *StageStruct) Nil() { // insertion point for array nil
	stage.BookDetailsGroups = nil
	stage.BookDetailsGroups_mapString = nil
...
func (stage *StageStruct) Unstage() { // insertion point for array nil
	for bookdetailsgroup := range stage.BookDetailsGroups {
		bookdetailsgroup.Unstage(stage)
	}
...
func GongGetSet[Type GongstructSet](stage *StageStruct) *Type {
	...
	case map[*BookDetailsGroup]any:
		return any(&stage.BookDetailsGroups).(*Type)
...
func GongGetMap[Type GongstructMapString](stage *StageStruct) *Type {
	...
	switch any(ret).(type) {
	// insertion point for generic get functions
	case map[string]*BookDetailsGroup:
		return any(&stage.BookDetailsGroups_mapString).(*Type)
...
func GetGongstructInstancesSet[Type Gongstruct](stage *StageStruct) *map[*Type]any {
	...
	case BookDetailsGroup:
		return any(&stage.BookDetailsGroups).(*map[*Type]any)
	case BookType:
...
func GetGongstructInstancesMap[Type Gongstruct](stage *StageStruct) *map[string]*Type {
	...
	// insertion point for generic get functions
	case BookDetailsGroup:
		return any(&stage.BookDetailsGroups_mapString).(*map[string]*Type)
	case BookType:
...
func GetPointerReverseMap[Start, End Gongstruct](fieldname string, stage *StageStruct) map[*End][]*Start {
	...
	// reverse maps of direct associations of BookDetailsGroup
	case BookDetailsGroup:
		switch fieldname {
