...
func IsStaged[Type Gongstruct](stage *StageStruct, instance *Type) (ok bool) {
	...
	case *BookDetailsGroup:
		ok = stage.IsStagedBookDetailsGroup(target)
...
func (stage *StageStruct) IsStagedBookDetailsGroup(bookdetailsgroup *BookDetailsGroup) (ok bool) {

	_, ok = stage.BookDetailsGroups[bookdetailsgroup]
...
func StageBranch[Type Gongstruct](stage *StageStruct, instance *Type) {
	...
	case *BookDetailsGroup:
		stage.StageBranchBookDetailsGroup(target)
...
func (stage *StageStruct) StageBranchBookDetailsGroup(bookdetailsgroup *BookDetailsGroup) {

	// check if instance is already staged
	if IsStaged(stage, bookdetailsgroup) {
		return
	}

	bookdetailsgroup.Stage(stage)
...
func CopyBranch[Type Gongstruct](from *Type) (to *Type) {
	...
	// insertion point for stage branch
	case *BookDetailsGroup:
		toT := CopyBranchBookDetailsGroup(mapOrigCopy, fromT)
		return any(toT).(*Type)
...
// insertion point for stage branch per struct
func CopyBranchBookDetailsGroup(mapOrigCopy map[any]any, bookdetailsgroupFrom *BookDetailsGroup) (bookdetailsgroupTo *BookDetailsGroup) {

	// bookdetailsgroupFrom has already been copied
	if _bookdetailsgroupTo, ok := mapOrigCopy[bookdetailsgroupFrom]; ok {
		bookdetailsgroupTo = _bookdetailsgroupTo.(*BookDetailsGroup)
		return
	}

	bookdetailsgroupTo = new(BookDetailsGroup)
	mapOrigCopy[bookdetailsgroupFrom] = bookdetailsgroupTo
	bookdetailsgroupFrom.CopyBasicFields(bookdetailsgroupTo)
...
func UnstageBranch[Type Gongstruct](stage *StageStruct, instance *Type) {
	...
	case *BookDetailsGroup:
		stage.UnstageBranchBookDetailsGroup(target)
...
func (stage *StageStruct) UnstageBranchBookDetailsGroup(bookdetailsgroup *BookDetailsGroup) {
