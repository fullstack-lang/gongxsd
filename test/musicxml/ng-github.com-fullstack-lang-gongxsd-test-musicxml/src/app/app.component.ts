...
import * as musicxml from '../../projects/musicxml/src/public-api'

import { MusicxmlspecificComponent } from '../../projects/musicxmlspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  musicxml = 'Musicxml'
  probe = 'Musicxml Data/Model'
  view = this.musicxml

  views: string[] = [this.musicxml, this.probe];
