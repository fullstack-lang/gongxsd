...
import * as reqif from '../../projects/reqif/src/public-api'

import { ReqifspecificComponent } from '../../projects/reqifspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  reqif = 'Reqif'
  probe = 'Reqif Data/Model'
  view = this.reqif

  views: string[] = [this.reqif, this.probe];
