...
func SerializeStage(stage *StageStruct, filename string) {
	...
	f := excelize.NewFile()
	{
		...
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_BOOLEAN_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_DATE_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_ENUMERATION_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_INTEGER_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_REAL_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_STRING_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_DEFINITION_XHTML_REF](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_BOOLEAN](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_DATE](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_ENUMERATION](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_INTEGER](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_REAL](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_STRING](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_XHTML](stage, f)
		SerializeExcelize[A_ATTRIBUTE_VALUE_XHTML_1](stage, f)
		SerializeExcelize[A_CHILDREN](stage, f)
		SerializeExcelize[A_CORE_CONTENT](stage, f)
		SerializeExcelize[A_DATATYPES](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_BOOLEAN_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_DATE_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_ENUMERATION_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_INTEGER_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_REAL_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_STRING_REF](stage, f)
		SerializeExcelize[A_DATATYPE_DEFINITION_XHTML_REF](stage, f)
		SerializeExcelize[A_EDITABLE_ATTS](stage, f)
		SerializeExcelize[A_ENUM_VALUE_REF](stage, f)
		SerializeExcelize[A_OBJECT](stage, f)
		SerializeExcelize[A_PROPERTIES](stage, f)
		SerializeExcelize[A_RELATION_GROUP_TYPE_REF](stage, f)
		SerializeExcelize[A_SPECIFICATIONS](stage, f)
		SerializeExcelize[A_SPECIFICATION_TYPE_REF](stage, f)
		...
		SerializeExcelize[A_SPEC_OBJECT_TYPE_REF](stage, f)
		SerializeExcelize[A_SPEC_RELATIONS](stage, f)
		SerializeExcelize[A_SPEC_RELATION_GROUPS](stage, f)
		SerializeExcelize[A_SPEC_RELATION_REF](stage, f)
		SerializeExcelize[A_SPEC_RELATION_TYPE_REF](stage, f)
		SerializeExcelize[A_SPEC_TYPES](stage, f)
		SerializeExcelize[A_TARGET_1](stage, f)
		SerializeExcelize[A_TARGET_SPECIFICATION_1](stage, f)
