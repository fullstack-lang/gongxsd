...
func SerializeStage(stage *StageStruct, filename string) {
	...
	f := excelize.NewFile()
	{
		...
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_DATE_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_REAL_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_STRING_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_DEFINITION_XHTML_REF_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_BOOLEAN_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_DATE_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_ENUMERATION_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_INTEGER_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_REAL_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_STRING_1](stage, f)
		SerializeExcelize[Renamed_ATTRIBUTE_VALUE_XHTML_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_BOOLEAN_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_DATE_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_ENUMERATION_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_INTEGER_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_REAL_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_STRING_REF_1](stage, f)
		SerializeExcelize[Renamed_DATATYPE_DEFINITION_XHTML_REF_1](stage, f)
		SerializeExcelize[Renamed_RELATION_GROUP_TYPE_REF_1](stage, f)
		SerializeExcelize[Renamed_SPECIFICATION_TYPE_REF_1](stage, f)
		SerializeExcelize[Renamed_SPEC_OBJECT_TYPE_REF_1](stage, f)
		SerializeExcelize[Renamed_SPEC_RELATION_TYPE_REF_1](stage, f)
