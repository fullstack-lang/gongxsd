...
func (backRepoDATATYPE_DEFINITION_STRING *BackRepoDATATYPE_DEFINITION_STRINGStruct) CommitPhaseTwoInstance(backRepo *BackRepoStruct, idx uint, datatype_definition_string *models.DATATYPE_DEFINITION_STRING) (Error error) {
	...
	if datatype_definition_stringDB, ok := backRepoDATATYPE_DEFINITION_STRING.Map_DATATYPE_DEFINITION_STRINGDBID_DATATYPE_DEFINITION_STRINGDB[idx]; ok {
		...
		// 1. reset
		datatype_definition_stringDB.DATATYPE_DEFINITION_STRINGPointersEncoding.ALTERNATIVE_ID = make([]int, 0)
		// 2. encode
		for _, a_alternative_idAssocEnd := range datatype_definition_string.ALTERNATIVE_ID {
			...
			datatype_definition_stringDB.DATATYPE_DEFINITION_STRINGPointersEncoding.ALTERNATIVE_ID =
				append(datatype_definition_stringDB.DATATYPE_DEFINITION_STRINGPointersEncoding.ALTERNATIVE_ID, int(a_alternative_idAssocEnd_DB.ID))
		}
...
func (datatype_definition_stringDB *DATATYPE_DEFINITION_STRINGDB) DecodePointers(backRepo *BackRepoStruct, datatype_definition_string *models.DATATYPE_DEFINITION_STRING) {
	...
	// This loop redeem datatype_definition_string.ALTERNATIVE_ID in the stage from the encode in the back repo
	// It parses all A_ALTERNATIVE_IDDB in the back repo and if the reverse pointer encoding matches the back repo ID
	// it appends the stage instance
	// 1. reset the slice
	datatype_definition_string.ALTERNATIVE_ID = datatype_definition_string.ALTERNATIVE_ID[:0]
	for _, _A_ALTERNATIVE_IDid := range datatype_definition_stringDB.DATATYPE_DEFINITION_STRINGPointersEncoding.ALTERNATIVE_ID {
		datatype_definition_string.ALTERNATIVE_ID = append(datatype_definition_string.ALTERNATIVE_ID, backRepo.BackRepoA_ALTERNATIVE_ID.Map_A_ALTERNATIVE_IDDBID_A_ALTERNATIVE_IDPtr[uint(_A_ALTERNATIVE_IDid)])
	}
