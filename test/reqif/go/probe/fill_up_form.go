...
func FillUpForm[T models.Gongstruct](
	...
	case *models.ATTRIBUTE_VALUE_BOOLEAN:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_BOOLEAN_1),
					"ATTRIBUTE_VALUE_BOOLEAN",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_BOOLEAN_1, *models.ATTRIBUTE_VALUE_BOOLEAN](
					nil,
					"ATTRIBUTE_VALUE_BOOLEAN",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_DATE:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_DATE_1),
					"ATTRIBUTE_VALUE_DATE",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_DATE_1, *models.ATTRIBUTE_VALUE_DATE](
					nil,
					"ATTRIBUTE_VALUE_DATE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_ENUMERATION:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_ENUMERATION_1),
					"ATTRIBUTE_VALUE_ENUMERATION",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_ENUMERATION_1, *models.ATTRIBUTE_VALUE_ENUMERATION](
					nil,
					"ATTRIBUTE_VALUE_ENUMERATION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_INTEGER:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_INTEGER_1),
					"ATTRIBUTE_VALUE_INTEGER",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_INTEGER_1, *models.ATTRIBUTE_VALUE_INTEGER](
					nil,
					"ATTRIBUTE_VALUE_INTEGER",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_REAL:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_REAL_1),
					"ATTRIBUTE_VALUE_REAL",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_REAL_1, *models.ATTRIBUTE_VALUE_REAL](
					nil,
					"ATTRIBUTE_VALUE_REAL",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_STRING:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_STRING_1),
					"ATTRIBUTE_VALUE_STRING",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_STRING_1, *models.ATTRIBUTE_VALUE_STRING](
					nil,
					"ATTRIBUTE_VALUE_STRING",
					instanceWithInferedType,
					formGroup,
	...
	case *models.ATTRIBUTE_VALUE_XHTML:
		...
		}
		{
			...
			if reverseFieldOwner != nil {
				AssociationReverseFieldToForm(
					reverseFieldOwner.(*models.Renamed_ATTRIBUTE_VALUE_XHTML_1),
					"ATTRIBUTE_VALUE_XHTML",
					instanceWithInferedType,
					formGroup,
					probe)
			} else {
				AssociationReverseFieldToForm[*models.Renamed_ATTRIBUTE_VALUE_XHTML_1, *models.ATTRIBUTE_VALUE_XHTML](
					nil,
					"ATTRIBUTE_VALUE_XHTML",
					instanceWithInferedType,
					formGroup,
	...
	case *models.A_SPEC_RELATIONS_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.RELATION_GROUP, *models.A_SPEC_RELATIONS_1](
					nil,
					"SPEC_RELATIONS",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_BOOLEAN, *models.Renamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_DATE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_DATE, *models.Renamed_ATTRIBUTE_DEFINITION_DATE_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_ENUMERATION, *models.Renamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_INTEGER, *models.Renamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_REAL_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_REAL, *models.Renamed_ATTRIBUTE_DEFINITION_REAL_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_STRING_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_STRING, *models.Renamed_ATTRIBUTE_DEFINITION_STRING_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_DEFINITION_XHTML_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_VALUE_XHTML, *models.Renamed_ATTRIBUTE_DEFINITION_XHTML_REF_1](
					nil,
					"DEFINITION",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_BOOLEAN_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_BOOLEAN", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_BOOLEAN, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_BOOLEAN, *models.Renamed_ATTRIBUTE_VALUE_BOOLEAN_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_DATE_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_DATE", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_DATE, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_DATE, *models.Renamed_ATTRIBUTE_VALUE_DATE_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_ENUMERATION_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_ENUMERATION", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_ENUMERATION, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_ENUMERATION, *models.Renamed_ATTRIBUTE_VALUE_ENUMERATION_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_INTEGER_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_INTEGER", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_INTEGER, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_INTEGER, *models.Renamed_ATTRIBUTE_VALUE_INTEGER_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_REAL_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_REAL", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_REAL, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_REAL, *models.Renamed_ATTRIBUTE_VALUE_REAL_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_STRING_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_STRING", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_STRING, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_STRING, *models.Renamed_ATTRIBUTE_VALUE_STRING_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_ATTRIBUTE_VALUE_XHTML_1:
		...
		AssociationSliceToForm("ATTRIBUTE_VALUE_XHTML", instanceWithInferedType, &instanceWithInferedType.ATTRIBUTE_VALUE_XHTML, formGroup, probe)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_XHTML, *models.Renamed_ATTRIBUTE_VALUE_XHTML_1](
					nil,
					"DEFAULT_VALUE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_BOOLEAN_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_BOOLEAN, *models.Renamed_DATATYPE_DEFINITION_BOOLEAN_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_DATE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_DATE, *models.Renamed_DATATYPE_DEFINITION_DATE_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_ENUMERATION_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_ENUMERATION, *models.Renamed_DATATYPE_DEFINITION_ENUMERATION_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_INTEGER_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_INTEGER, *models.Renamed_DATATYPE_DEFINITION_INTEGER_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_REAL_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_REAL, *models.Renamed_DATATYPE_DEFINITION_REAL_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_STRING_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_STRING, *models.Renamed_DATATYPE_DEFINITION_STRING_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_DATATYPE_DEFINITION_XHTML_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.ATTRIBUTE_DEFINITION_XHTML, *models.Renamed_DATATYPE_DEFINITION_XHTML_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_RELATION_GROUP_TYPE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.RELATION_GROUP, *models.Renamed_RELATION_GROUP_TYPE_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_SPECIFICATION_TYPE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.SPECIFICATION, *models.Renamed_SPECIFICATION_TYPE_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_SPEC_OBJECT_TYPE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.SPEC_OBJECT, *models.Renamed_SPEC_OBJECT_TYPE_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
	...
	case *models.Renamed_SPEC_RELATION_TYPE_REF_1:
			...
			false, false, 0, false, 0)
		{
			...
			if reverseFieldOwner != nil {
				...
				AssociationReverseFieldToForm[*models.SPEC_RELATION, *models.Renamed_SPEC_RELATION_TYPE_REF_1](
					nil,
					"TYPE",
					instanceWithInferedType,
					formGroup,
