...
import (
	...
	"github.com/fullstack-lang/gongxsd/test/reqif"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(reqif.NgDistNg, "ng-github.com-fullstack-lang-gongxsd-test-reqif/dist/ng-github.com-fullstack-lang-gongxsd-test-reqif/browser")))
