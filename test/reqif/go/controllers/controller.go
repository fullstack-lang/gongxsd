...
import (
	...
	reqif_orm "github.com/fullstack-lang/gongxsd/test/reqif/go/orm"
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*reqif_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *reqif_orm.BackRepoStruct, stackPath string) {
