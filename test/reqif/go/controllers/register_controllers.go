...
func registerControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		...
		v1.GET("/v1/a_default_values", GetController().GetA_DEFAULT_VALUEs)
		v1.GET("/v1/a_default_values/:id", GetController().GetA_DEFAULT_VALUE)
		v1.POST("/v1/a_default_values", GetController().PostA_DEFAULT_VALUE)
		v1.PATCH("/v1/a_default_values/:id", GetController().UpdateA_DEFAULT_VALUE)
		v1.PUT("/v1/a_default_values/:id", GetController().UpdateA_DEFAULT_VALUE)
		v1.DELETE("/v1/a_default_values/:id", GetController().DeleteA_DEFAULT_VALUE)

		v1.GET("/v1/a_default_value_1s", GetController().GetA_DEFAULT_VALUE_1s)
		v1.GET("/v1/a_default_value_1s/:id", GetController().GetA_DEFAULT_VALUE_1)
		v1.POST("/v1/a_default_value_1s", GetController().PostA_DEFAULT_VALUE_1)
		v1.PATCH("/v1/a_default_value_1s/:id", GetController().UpdateA_DEFAULT_VALUE_1)
		v1.PUT("/v1/a_default_value_1s/:id", GetController().UpdateA_DEFAULT_VALUE_1)
		v1.DELETE("/v1/a_default_value_1s/:id", GetController().DeleteA_DEFAULT_VALUE_1)

		v1.GET("/v1/a_default_value_2s", GetController().GetA_DEFAULT_VALUE_2s)
		v1.GET("/v1/a_default_value_2s/:id", GetController().GetA_DEFAULT_VALUE_2)
		v1.POST("/v1/a_default_value_2s", GetController().PostA_DEFAULT_VALUE_2)
		v1.PATCH("/v1/a_default_value_2s/:id", GetController().UpdateA_DEFAULT_VALUE_2)
		v1.PUT("/v1/a_default_value_2s/:id", GetController().UpdateA_DEFAULT_VALUE_2)
		v1.DELETE("/v1/a_default_value_2s/:id", GetController().DeleteA_DEFAULT_VALUE_2)

		v1.GET("/v1/a_default_value_3s", GetController().GetA_DEFAULT_VALUE_3s)
		v1.GET("/v1/a_default_value_3s/:id", GetController().GetA_DEFAULT_VALUE_3)
		v1.POST("/v1/a_default_value_3s", GetController().PostA_DEFAULT_VALUE_3)
		v1.PATCH("/v1/a_default_value_3s/:id", GetController().UpdateA_DEFAULT_VALUE_3)
		v1.PUT("/v1/a_default_value_3s/:id", GetController().UpdateA_DEFAULT_VALUE_3)
		v1.DELETE("/v1/a_default_value_3s/:id", GetController().DeleteA_DEFAULT_VALUE_3)

		v1.GET("/v1/a_default_value_4s", GetController().GetA_DEFAULT_VALUE_4s)
		v1.GET("/v1/a_default_value_4s/:id", GetController().GetA_DEFAULT_VALUE_4)
		v1.POST("/v1/a_default_value_4s", GetController().PostA_DEFAULT_VALUE_4)
		v1.PATCH("/v1/a_default_value_4s/:id", GetController().UpdateA_DEFAULT_VALUE_4)
		v1.PUT("/v1/a_default_value_4s/:id", GetController().UpdateA_DEFAULT_VALUE_4)
		v1.DELETE("/v1/a_default_value_4s/:id", GetController().DeleteA_DEFAULT_VALUE_4)

		v1.GET("/v1/a_default_value_5s", GetController().GetA_DEFAULT_VALUE_5s)
		v1.GET("/v1/a_default_value_5s/:id", GetController().GetA_DEFAULT_VALUE_5)
		v1.POST("/v1/a_default_value_5s", GetController().PostA_DEFAULT_VALUE_5)
		v1.PATCH("/v1/a_default_value_5s/:id", GetController().UpdateA_DEFAULT_VALUE_5)
		v1.PUT("/v1/a_default_value_5s/:id", GetController().UpdateA_DEFAULT_VALUE_5)
		v1.DELETE("/v1/a_default_value_5s/:id", GetController().DeleteA_DEFAULT_VALUE_5)

		v1.GET("/v1/a_default_value_6s", GetController().GetA_DEFAULT_VALUE_6s)
		v1.GET("/v1/a_default_value_6s/:id", GetController().GetA_DEFAULT_VALUE_6)
		v1.POST("/v1/a_default_value_6s", GetController().PostA_DEFAULT_VALUE_6)
		v1.PATCH("/v1/a_default_value_6s/:id", GetController().UpdateA_DEFAULT_VALUE_6)
		v1.PUT("/v1/a_default_value_6s/:id", GetController().UpdateA_DEFAULT_VALUE_6)
		v1.DELETE("/v1/a_default_value_6s/:id", GetController().DeleteA_DEFAULT_VALUE_6)

		v1.GET("/v1/a_definitions", GetController().GetA_DEFINITIONs)
		v1.GET("/v1/a_definitions/:id", GetController().GetA_DEFINITION)
		v1.POST("/v1/a_definitions", GetController().PostA_DEFINITION)
		v1.PATCH("/v1/a_definitions/:id", GetController().UpdateA_DEFINITION)
		v1.PUT("/v1/a_definitions/:id", GetController().UpdateA_DEFINITION)
		v1.DELETE("/v1/a_definitions/:id", GetController().DeleteA_DEFINITION)

		v1.GET("/v1/a_definition_1s", GetController().GetA_DEFINITION_1s)
		v1.GET("/v1/a_definition_1s/:id", GetController().GetA_DEFINITION_1)
		v1.POST("/v1/a_definition_1s", GetController().PostA_DEFINITION_1)
		v1.PATCH("/v1/a_definition_1s/:id", GetController().UpdateA_DEFINITION_1)
		v1.PUT("/v1/a_definition_1s/:id", GetController().UpdateA_DEFINITION_1)
		v1.DELETE("/v1/a_definition_1s/:id", GetController().DeleteA_DEFINITION_1)

		v1.GET("/v1/a_definition_2s", GetController().GetA_DEFINITION_2s)
		v1.GET("/v1/a_definition_2s/:id", GetController().GetA_DEFINITION_2)
		v1.POST("/v1/a_definition_2s", GetController().PostA_DEFINITION_2)
		v1.PATCH("/v1/a_definition_2s/:id", GetController().UpdateA_DEFINITION_2)
		v1.PUT("/v1/a_definition_2s/:id", GetController().UpdateA_DEFINITION_2)
		v1.DELETE("/v1/a_definition_2s/:id", GetController().DeleteA_DEFINITION_2)

		v1.GET("/v1/a_definition_3s", GetController().GetA_DEFINITION_3s)
		v1.GET("/v1/a_definition_3s/:id", GetController().GetA_DEFINITION_3)
		v1.POST("/v1/a_definition_3s", GetController().PostA_DEFINITION_3)
		v1.PATCH("/v1/a_definition_3s/:id", GetController().UpdateA_DEFINITION_3)
		v1.PUT("/v1/a_definition_3s/:id", GetController().UpdateA_DEFINITION_3)
		v1.DELETE("/v1/a_definition_3s/:id", GetController().DeleteA_DEFINITION_3)

		v1.GET("/v1/a_definition_4s", GetController().GetA_DEFINITION_4s)
		v1.GET("/v1/a_definition_4s/:id", GetController().GetA_DEFINITION_4)
		v1.POST("/v1/a_definition_4s", GetController().PostA_DEFINITION_4)
		v1.PATCH("/v1/a_definition_4s/:id", GetController().UpdateA_DEFINITION_4)
		v1.PUT("/v1/a_definition_4s/:id", GetController().UpdateA_DEFINITION_4)
		v1.DELETE("/v1/a_definition_4s/:id", GetController().DeleteA_DEFINITION_4)

		v1.GET("/v1/a_definition_5s", GetController().GetA_DEFINITION_5s)
		v1.GET("/v1/a_definition_5s/:id", GetController().GetA_DEFINITION_5)
		v1.POST("/v1/a_definition_5s", GetController().PostA_DEFINITION_5)
		v1.PATCH("/v1/a_definition_5s/:id", GetController().UpdateA_DEFINITION_5)
		v1.PUT("/v1/a_definition_5s/:id", GetController().UpdateA_DEFINITION_5)
		v1.DELETE("/v1/a_definition_5s/:id", GetController().DeleteA_DEFINITION_5)

		v1.GET("/v1/a_definition_6s", GetController().GetA_DEFINITION_6s)
		v1.GET("/v1/a_definition_6s/:id", GetController().GetA_DEFINITION_6)
		v1.POST("/v1/a_definition_6s", GetController().PostA_DEFINITION_6)
		v1.PATCH("/v1/a_definition_6s/:id", GetController().UpdateA_DEFINITION_6)
		v1.PUT("/v1/a_definition_6s/:id", GetController().UpdateA_DEFINITION_6)
		v1.DELETE("/v1/a_definition_6s/:id", GetController().DeleteA_DEFINITION_6)
		...
		v1.GET("/v1/a_types", GetController().GetA_TYPEs)
		v1.GET("/v1/a_types/:id", GetController().GetA_TYPE)
		v1.POST("/v1/a_types", GetController().PostA_TYPE)
		v1.PATCH("/v1/a_types/:id", GetController().UpdateA_TYPE)
		v1.PUT("/v1/a_types/:id", GetController().UpdateA_TYPE)
		v1.DELETE("/v1/a_types/:id", GetController().DeleteA_TYPE)

		v1.GET("/v1/a_type_1s", GetController().GetA_TYPE_1s)
		v1.GET("/v1/a_type_1s/:id", GetController().GetA_TYPE_1)
		v1.POST("/v1/a_type_1s", GetController().PostA_TYPE_1)
		v1.PATCH("/v1/a_type_1s/:id", GetController().UpdateA_TYPE_1)
		v1.PUT("/v1/a_type_1s/:id", GetController().UpdateA_TYPE_1)
		v1.DELETE("/v1/a_type_1s/:id", GetController().DeleteA_TYPE_1)

		v1.GET("/v1/a_type_10s", GetController().GetA_TYPE_10s)
		v1.GET("/v1/a_type_10s/:id", GetController().GetA_TYPE_10)
		v1.POST("/v1/a_type_10s", GetController().PostA_TYPE_10)
		v1.PATCH("/v1/a_type_10s/:id", GetController().UpdateA_TYPE_10)
		v1.PUT("/v1/a_type_10s/:id", GetController().UpdateA_TYPE_10)
		v1.DELETE("/v1/a_type_10s/:id", GetController().DeleteA_TYPE_10)

		v1.GET("/v1/a_type_2s", GetController().GetA_TYPE_2s)
		v1.GET("/v1/a_type_2s/:id", GetController().GetA_TYPE_2)
		v1.POST("/v1/a_type_2s", GetController().PostA_TYPE_2)
		v1.PATCH("/v1/a_type_2s/:id", GetController().UpdateA_TYPE_2)
		v1.PUT("/v1/a_type_2s/:id", GetController().UpdateA_TYPE_2)
		v1.DELETE("/v1/a_type_2s/:id", GetController().DeleteA_TYPE_2)

		v1.GET("/v1/a_type_3s", GetController().GetA_TYPE_3s)
		v1.GET("/v1/a_type_3s/:id", GetController().GetA_TYPE_3)
		v1.POST("/v1/a_type_3s", GetController().PostA_TYPE_3)
		v1.PATCH("/v1/a_type_3s/:id", GetController().UpdateA_TYPE_3)
		v1.PUT("/v1/a_type_3s/:id", GetController().UpdateA_TYPE_3)
		v1.DELETE("/v1/a_type_3s/:id", GetController().DeleteA_TYPE_3)

		v1.GET("/v1/a_type_4s", GetController().GetA_TYPE_4s)
		v1.GET("/v1/a_type_4s/:id", GetController().GetA_TYPE_4)
		v1.POST("/v1/a_type_4s", GetController().PostA_TYPE_4)
		v1.PATCH("/v1/a_type_4s/:id", GetController().UpdateA_TYPE_4)
		v1.PUT("/v1/a_type_4s/:id", GetController().UpdateA_TYPE_4)
		v1.DELETE("/v1/a_type_4s/:id", GetController().DeleteA_TYPE_4)

		v1.GET("/v1/a_type_5s", GetController().GetA_TYPE_5s)
		v1.GET("/v1/a_type_5s/:id", GetController().GetA_TYPE_5)
		v1.POST("/v1/a_type_5s", GetController().PostA_TYPE_5)
		v1.PATCH("/v1/a_type_5s/:id", GetController().UpdateA_TYPE_5)
		v1.PUT("/v1/a_type_5s/:id", GetController().UpdateA_TYPE_5)
		v1.DELETE("/v1/a_type_5s/:id", GetController().DeleteA_TYPE_5)

		v1.GET("/v1/a_type_6s", GetController().GetA_TYPE_6s)
		v1.GET("/v1/a_type_6s/:id", GetController().GetA_TYPE_6)
		v1.POST("/v1/a_type_6s", GetController().PostA_TYPE_6)
		v1.PATCH("/v1/a_type_6s/:id", GetController().UpdateA_TYPE_6)
		v1.PUT("/v1/a_type_6s/:id", GetController().UpdateA_TYPE_6)
		v1.DELETE("/v1/a_type_6s/:id", GetController().DeleteA_TYPE_6)

		v1.GET("/v1/a_type_7s", GetController().GetA_TYPE_7s)
		v1.GET("/v1/a_type_7s/:id", GetController().GetA_TYPE_7)
		v1.POST("/v1/a_type_7s", GetController().PostA_TYPE_7)
		v1.PATCH("/v1/a_type_7s/:id", GetController().UpdateA_TYPE_7)
		v1.PUT("/v1/a_type_7s/:id", GetController().UpdateA_TYPE_7)
		v1.DELETE("/v1/a_type_7s/:id", GetController().DeleteA_TYPE_7)

		v1.GET("/v1/a_type_8s", GetController().GetA_TYPE_8s)
		v1.GET("/v1/a_type_8s/:id", GetController().GetA_TYPE_8)
		v1.POST("/v1/a_type_8s", GetController().PostA_TYPE_8)
		v1.PATCH("/v1/a_type_8s/:id", GetController().UpdateA_TYPE_8)
		v1.PUT("/v1/a_type_8s/:id", GetController().UpdateA_TYPE_8)
		v1.DELETE("/v1/a_type_8s/:id", GetController().DeleteA_TYPE_8)

		v1.GET("/v1/a_type_9s", GetController().GetA_TYPE_9s)
		v1.GET("/v1/a_type_9s/:id", GetController().GetA_TYPE_9)
		v1.POST("/v1/a_type_9s", GetController().PostA_TYPE_9)
		v1.PATCH("/v1/a_type_9s/:id", GetController().UpdateA_TYPE_9)
		v1.PUT("/v1/a_type_9s/:id", GetController().UpdateA_TYPE_9)
		v1.DELETE("/v1/a_type_9s/:id", GetController().DeleteA_TYPE_9)
