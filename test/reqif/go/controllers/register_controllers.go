...
func registerControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		...
		v1.GET("/v1/a_sources", GetController().GetA_SOURCEs)
		v1.GET("/v1/a_sources/:id", GetController().GetA_SOURCE)
		v1.POST("/v1/a_sources", GetController().PostA_SOURCE)
		v1.PATCH("/v1/a_sources/:id", GetController().UpdateA_SOURCE)
		v1.PUT("/v1/a_sources/:id", GetController().UpdateA_SOURCE)
		v1.DELETE("/v1/a_sources/:id", GetController().DeleteA_SOURCE)

		v1.GET("/v1/a_source_specifications", GetController().GetA_SOURCE_SPECIFICATIONs)
		v1.GET("/v1/a_source_specifications/:id", GetController().GetA_SOURCE_SPECIFICATION)
		v1.POST("/v1/a_source_specifications", GetController().PostA_SOURCE_SPECIFICATION)
		v1.PATCH("/v1/a_source_specifications/:id", GetController().UpdateA_SOURCE_SPECIFICATION)
		v1.PUT("/v1/a_source_specifications/:id", GetController().UpdateA_SOURCE_SPECIFICATION)
		v1.DELETE("/v1/a_source_specifications/:id", GetController().DeleteA_SOURCE_SPECIFICATION)
		...
		v1.GET("/v1/a_spec_relations_1s", GetController().GetA_SPEC_RELATIONS_1s)
		v1.GET("/v1/a_spec_relations_1s/:id", GetController().GetA_SPEC_RELATIONS_1)
		v1.POST("/v1/a_spec_relations_1s", GetController().PostA_SPEC_RELATIONS_1)
		v1.PATCH("/v1/a_spec_relations_1s/:id", GetController().UpdateA_SPEC_RELATIONS_1)
		v1.PUT("/v1/a_spec_relations_1s/:id", GetController().UpdateA_SPEC_RELATIONS_1)
		v1.DELETE("/v1/a_spec_relations_1s/:id", GetController().DeleteA_SPEC_RELATIONS_1)
		...
		v1.GET("/v1/a_valuess", GetController().GetA_VALUESs)
		v1.GET("/v1/a_valuess/:id", GetController().GetA_VALUES)
		v1.POST("/v1/a_valuess", GetController().PostA_VALUES)
		v1.PATCH("/v1/a_valuess/:id", GetController().UpdateA_VALUES)
		v1.PUT("/v1/a_valuess/:id", GetController().UpdateA_VALUES)
		v1.DELETE("/v1/a_valuess/:id", GetController().DeleteA_VALUES)

		v1.GET("/v1/a_values_1s", GetController().GetA_VALUES_1s)
		v1.GET("/v1/a_values_1s/:id", GetController().GetA_VALUES_1)
		v1.POST("/v1/a_values_1s", GetController().PostA_VALUES_1)
		v1.PATCH("/v1/a_values_1s/:id", GetController().UpdateA_VALUES_1)
		v1.PUT("/v1/a_values_1s/:id", GetController().UpdateA_VALUES_1)
		v1.DELETE("/v1/a_values_1s/:id", GetController().DeleteA_VALUES_1)
		...
		v1.GET("/v1/renamed_attribute_definition_boolean_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_boolean_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1)
		v1.POST("/v1/renamed_attribute_definition_boolean_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_boolean_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_boolean_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_boolean_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_BOOLEAN_REF_1)

		v1.GET("/v1/renamed_attribute_definition_date_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_date_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1)
		v1.POST("/v1/renamed_attribute_definition_date_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_date_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_date_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_date_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_DATE_REF_1)

		v1.GET("/v1/renamed_attribute_definition_enumeration_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_enumeration_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1)
		v1.POST("/v1/renamed_attribute_definition_enumeration_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_enumeration_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_enumeration_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_enumeration_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_ENUMERATION_REF_1)

		v1.GET("/v1/renamed_attribute_definition_integer_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_integer_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1)
		v1.POST("/v1/renamed_attribute_definition_integer_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_integer_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_integer_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_integer_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_INTEGER_REF_1)

		v1.GET("/v1/renamed_attribute_definition_real_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_real_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1)
		v1.POST("/v1/renamed_attribute_definition_real_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_real_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_real_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_real_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_REAL_REF_1)

		v1.GET("/v1/renamed_attribute_definition_string_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_string_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1)
		v1.POST("/v1/renamed_attribute_definition_string_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_string_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_string_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_string_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_STRING_REF_1)

		v1.GET("/v1/renamed_attribute_definition_xhtml_ref_1s", GetController().GetRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1s)
		v1.GET("/v1/renamed_attribute_definition_xhtml_ref_1s/:id", GetController().GetRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1)
		v1.POST("/v1/renamed_attribute_definition_xhtml_ref_1s", GetController().PostRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1)
		v1.PATCH("/v1/renamed_attribute_definition_xhtml_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1)
		v1.PUT("/v1/renamed_attribute_definition_xhtml_ref_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1)
		v1.DELETE("/v1/renamed_attribute_definition_xhtml_ref_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_DEFINITION_XHTML_REF_1)

		v1.GET("/v1/renamed_attribute_value_boolean_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_BOOLEAN_1s)
		v1.GET("/v1/renamed_attribute_value_boolean_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_BOOLEAN_1)
		v1.POST("/v1/renamed_attribute_value_boolean_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_BOOLEAN_1)
		v1.PATCH("/v1/renamed_attribute_value_boolean_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_BOOLEAN_1)
		v1.PUT("/v1/renamed_attribute_value_boolean_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_BOOLEAN_1)
		v1.DELETE("/v1/renamed_attribute_value_boolean_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_BOOLEAN_1)

		v1.GET("/v1/renamed_attribute_value_date_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_DATE_1s)
		v1.GET("/v1/renamed_attribute_value_date_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_DATE_1)
		v1.POST("/v1/renamed_attribute_value_date_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_DATE_1)
		v1.PATCH("/v1/renamed_attribute_value_date_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_DATE_1)
		v1.PUT("/v1/renamed_attribute_value_date_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_DATE_1)
		v1.DELETE("/v1/renamed_attribute_value_date_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_DATE_1)

		v1.GET("/v1/renamed_attribute_value_enumeration_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_ENUMERATION_1s)
		v1.GET("/v1/renamed_attribute_value_enumeration_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_ENUMERATION_1)
		v1.POST("/v1/renamed_attribute_value_enumeration_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_ENUMERATION_1)
		v1.PATCH("/v1/renamed_attribute_value_enumeration_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_ENUMERATION_1)
		v1.PUT("/v1/renamed_attribute_value_enumeration_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_ENUMERATION_1)
		v1.DELETE("/v1/renamed_attribute_value_enumeration_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_ENUMERATION_1)

		v1.GET("/v1/renamed_attribute_value_integer_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_INTEGER_1s)
		v1.GET("/v1/renamed_attribute_value_integer_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_INTEGER_1)
		v1.POST("/v1/renamed_attribute_value_integer_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_INTEGER_1)
		v1.PATCH("/v1/renamed_attribute_value_integer_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_INTEGER_1)
		v1.PUT("/v1/renamed_attribute_value_integer_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_INTEGER_1)
		v1.DELETE("/v1/renamed_attribute_value_integer_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_INTEGER_1)

		v1.GET("/v1/renamed_attribute_value_real_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_REAL_1s)
		v1.GET("/v1/renamed_attribute_value_real_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_REAL_1)
		v1.POST("/v1/renamed_attribute_value_real_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_REAL_1)
		v1.PATCH("/v1/renamed_attribute_value_real_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_REAL_1)
		v1.PUT("/v1/renamed_attribute_value_real_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_REAL_1)
		v1.DELETE("/v1/renamed_attribute_value_real_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_REAL_1)

		v1.GET("/v1/renamed_attribute_value_string_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_STRING_1s)
		v1.GET("/v1/renamed_attribute_value_string_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_STRING_1)
		v1.POST("/v1/renamed_attribute_value_string_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_STRING_1)
		v1.PATCH("/v1/renamed_attribute_value_string_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_STRING_1)
		v1.PUT("/v1/renamed_attribute_value_string_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_STRING_1)
		v1.DELETE("/v1/renamed_attribute_value_string_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_STRING_1)

		v1.GET("/v1/renamed_attribute_value_xhtml_1s", GetController().GetRenamed_ATTRIBUTE_VALUE_XHTML_1s)
		v1.GET("/v1/renamed_attribute_value_xhtml_1s/:id", GetController().GetRenamed_ATTRIBUTE_VALUE_XHTML_1)
		v1.POST("/v1/renamed_attribute_value_xhtml_1s", GetController().PostRenamed_ATTRIBUTE_VALUE_XHTML_1)
		v1.PATCH("/v1/renamed_attribute_value_xhtml_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_XHTML_1)
		v1.PUT("/v1/renamed_attribute_value_xhtml_1s/:id", GetController().UpdateRenamed_ATTRIBUTE_VALUE_XHTML_1)
		v1.DELETE("/v1/renamed_attribute_value_xhtml_1s/:id", GetController().DeleteRenamed_ATTRIBUTE_VALUE_XHTML_1)

		v1.GET("/v1/renamed_datatype_definition_boolean_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_boolean_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1)
		v1.POST("/v1/renamed_datatype_definition_boolean_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_boolean_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_boolean_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_boolean_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_BOOLEAN_REF_1)

		v1.GET("/v1/renamed_datatype_definition_date_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_DATE_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_date_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_DATE_REF_1)
		v1.POST("/v1/renamed_datatype_definition_date_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_DATE_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_date_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_DATE_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_date_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_DATE_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_date_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_DATE_REF_1)

		v1.GET("/v1/renamed_datatype_definition_enumeration_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_enumeration_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1)
		v1.POST("/v1/renamed_datatype_definition_enumeration_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_enumeration_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_enumeration_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_enumeration_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_ENUMERATION_REF_1)

		v1.GET("/v1/renamed_datatype_definition_integer_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_INTEGER_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_integer_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_INTEGER_REF_1)
		v1.POST("/v1/renamed_datatype_definition_integer_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_INTEGER_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_integer_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_INTEGER_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_integer_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_INTEGER_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_integer_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_INTEGER_REF_1)

		v1.GET("/v1/renamed_datatype_definition_real_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_REAL_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_real_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_REAL_REF_1)
		v1.POST("/v1/renamed_datatype_definition_real_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_REAL_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_real_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_REAL_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_real_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_REAL_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_real_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_REAL_REF_1)

		v1.GET("/v1/renamed_datatype_definition_string_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_STRING_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_string_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_STRING_REF_1)
		v1.POST("/v1/renamed_datatype_definition_string_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_STRING_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_string_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_STRING_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_string_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_STRING_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_string_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_STRING_REF_1)

		v1.GET("/v1/renamed_datatype_definition_xhtml_ref_1s", GetController().GetRenamed_DATATYPE_DEFINITION_XHTML_REF_1s)
		v1.GET("/v1/renamed_datatype_definition_xhtml_ref_1s/:id", GetController().GetRenamed_DATATYPE_DEFINITION_XHTML_REF_1)
		v1.POST("/v1/renamed_datatype_definition_xhtml_ref_1s", GetController().PostRenamed_DATATYPE_DEFINITION_XHTML_REF_1)
		v1.PATCH("/v1/renamed_datatype_definition_xhtml_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_XHTML_REF_1)
		v1.PUT("/v1/renamed_datatype_definition_xhtml_ref_1s/:id", GetController().UpdateRenamed_DATATYPE_DEFINITION_XHTML_REF_1)
		v1.DELETE("/v1/renamed_datatype_definition_xhtml_ref_1s/:id", GetController().DeleteRenamed_DATATYPE_DEFINITION_XHTML_REF_1)

		v1.GET("/v1/renamed_relation_group_type_ref_1s", GetController().GetRenamed_RELATION_GROUP_TYPE_REF_1s)
		v1.GET("/v1/renamed_relation_group_type_ref_1s/:id", GetController().GetRenamed_RELATION_GROUP_TYPE_REF_1)
		v1.POST("/v1/renamed_relation_group_type_ref_1s", GetController().PostRenamed_RELATION_GROUP_TYPE_REF_1)
		v1.PATCH("/v1/renamed_relation_group_type_ref_1s/:id", GetController().UpdateRenamed_RELATION_GROUP_TYPE_REF_1)
		v1.PUT("/v1/renamed_relation_group_type_ref_1s/:id", GetController().UpdateRenamed_RELATION_GROUP_TYPE_REF_1)
		v1.DELETE("/v1/renamed_relation_group_type_ref_1s/:id", GetController().DeleteRenamed_RELATION_GROUP_TYPE_REF_1)

		v1.GET("/v1/renamed_specification_type_ref_1s", GetController().GetRenamed_SPECIFICATION_TYPE_REF_1s)
		v1.GET("/v1/renamed_specification_type_ref_1s/:id", GetController().GetRenamed_SPECIFICATION_TYPE_REF_1)
		v1.POST("/v1/renamed_specification_type_ref_1s", GetController().PostRenamed_SPECIFICATION_TYPE_REF_1)
		v1.PATCH("/v1/renamed_specification_type_ref_1s/:id", GetController().UpdateRenamed_SPECIFICATION_TYPE_REF_1)
		v1.PUT("/v1/renamed_specification_type_ref_1s/:id", GetController().UpdateRenamed_SPECIFICATION_TYPE_REF_1)
		v1.DELETE("/v1/renamed_specification_type_ref_1s/:id", GetController().DeleteRenamed_SPECIFICATION_TYPE_REF_1)

		v1.GET("/v1/renamed_spec_object_type_ref_1s", GetController().GetRenamed_SPEC_OBJECT_TYPE_REF_1s)
		v1.GET("/v1/renamed_spec_object_type_ref_1s/:id", GetController().GetRenamed_SPEC_OBJECT_TYPE_REF_1)
		v1.POST("/v1/renamed_spec_object_type_ref_1s", GetController().PostRenamed_SPEC_OBJECT_TYPE_REF_1)
		v1.PATCH("/v1/renamed_spec_object_type_ref_1s/:id", GetController().UpdateRenamed_SPEC_OBJECT_TYPE_REF_1)
		v1.PUT("/v1/renamed_spec_object_type_ref_1s/:id", GetController().UpdateRenamed_SPEC_OBJECT_TYPE_REF_1)
		v1.DELETE("/v1/renamed_spec_object_type_ref_1s/:id", GetController().DeleteRenamed_SPEC_OBJECT_TYPE_REF_1)

		v1.GET("/v1/renamed_spec_relation_type_ref_1s", GetController().GetRenamed_SPEC_RELATION_TYPE_REF_1s)
		v1.GET("/v1/renamed_spec_relation_type_ref_1s/:id", GetController().GetRenamed_SPEC_RELATION_TYPE_REF_1)
		v1.POST("/v1/renamed_spec_relation_type_ref_1s", GetController().PostRenamed_SPEC_RELATION_TYPE_REF_1)
		v1.PATCH("/v1/renamed_spec_relation_type_ref_1s/:id", GetController().UpdateRenamed_SPEC_RELATION_TYPE_REF_1)
		v1.PUT("/v1/renamed_spec_relation_type_ref_1s/:id", GetController().UpdateRenamed_SPEC_RELATION_TYPE_REF_1)
		v1.DELETE("/v1/renamed_spec_relation_type_ref_1s/:id", GetController().DeleteRenamed_SPEC_RELATION_TYPE_REF_1)
