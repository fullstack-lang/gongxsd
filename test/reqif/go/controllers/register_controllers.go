...
func (controller *Controller) onWebSocketRequestForBackRepoContent(c *gin.Context) {
	...
	if backRepo == nil {
		message := "WebSocket Connect, Stack github.com/fullstack-lang/gongxsd/test/reqif/go, Unkown stack: \"" + stackPath + "\"\n"
	...
	go func() {
		for {
			...
			if err != nil {
				log.Println("github.com/fullstack-lang/gongxsd/test/reqif/go", stackPath, "WS client disconnected:", err)
	...
	if err != nil {
		log.Println("github.com/fullstack-lang/gongxsd/test/reqif/go:\n",
		...
		parts := strings.Split("github.com/fullstack-lang/gongxsd/test/reqif/go", "/") // Assuming goFilePath holds the path
		component := "unknown"
		if len(parts) > 2 {
