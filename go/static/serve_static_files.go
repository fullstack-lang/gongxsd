...
import (
	...
	"github.com/fullstack-lang/gongxsd"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongxsd.NgDistNg, "ng-github.com-fullstack-lang-gongxsd/dist/ng-github.com-fullstack-lang-gongxsd/browser")))
