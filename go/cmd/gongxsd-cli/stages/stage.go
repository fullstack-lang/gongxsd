...
func _(stage *models.StageStruct) {
	...
	__Element__000003_format.HasNameConflict = false
	__Element__000003_format.GoIdentifier = `Format`
	...
	__Element__000004_title.HasNameConflict = false
	__Element__000004_title.GoIdentifier = `Title`
	...
	__Element__000005_year.HasNameConflict = false
	__Element__000005_year.GoIdentifier = `Year`
