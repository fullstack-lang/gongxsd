...
import (
	...
	gongxsd_orm "github.com/fullstack-lang/gongxsd/go/orm"
...
type Controller struct {
	...
	Map_BackRepos map[string]*gongxsd_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongxsd_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongxsd_orm.BackRepoStruct, stackPath string) {
