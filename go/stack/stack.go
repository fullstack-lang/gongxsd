...
import (
	...
	"github.com/fullstack-lang/gongxsd/go/fullstack"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongxsd/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongxsd_go.GoModelsDir, gongxsd_go.GoDiagramsDir,
