...
func _(stage *models.StageStruct) {
	...
	__GongStructShape__000005_Default_Pattern := (&models.GongStructShape{Name: `Default-Pattern`}).Stage(stage)
	__GongStructShape__000006_Default_Restriction := (&models.GongStructShape{Name: `Default-Restriction`}).Stage(stage)
	__GongStructShape__000007_Default_Schema := (&models.GongStructShape{Name: `Default-Schema`}).Stage(stage)
	__GongStructShape__000008_Default_Sequence := (&models.GongStructShape{Name: `Default-Sequence`}).Stage(stage)
	__GongStructShape__000009_Default_SimpleType := (&models.GongStructShape{Name: `Default-SimpleType`}).Stage(stage)
	...
	__Link__000007_Pattern := (&models.Link{Name: `Pattern`}).Stage(stage)
	__Link__000008_Restriction := (&models.Link{Name: `Restriction`}).Stage(stage)
	__Link__000009_Sequence := (&models.Link{Name: `Sequence`}).Stage(stage)
	__Link__000010_SimpleType := (&models.Link{Name: `SimpleType`}).Stage(stage)
	__Link__000011_SimpleTypes := (&models.Link{Name: `SimpleTypes`}).Stage(stage)
	...
	__Position__000005_Pos_Default_Pattern := (&models.Position{Name: `Pos-Default-Pattern`}).Stage(stage)
	__Position__000006_Pos_Default_Restriction := (&models.Position{Name: `Pos-Default-Restriction`}).Stage(stage)
	__Position__000007_Pos_Default_Schema := (&models.Position{Name: `Pos-Default-Schema`}).Stage(stage)
	__Position__000008_Pos_Default_Sequence := (&models.Position{Name: `Pos-Default-Sequence`}).Stage(stage)
	__Position__000009_Pos_Default_SimpleType := (&models.Position{Name: `Pos-Default-SimpleType`}).Stage(stage)
	...
	__Vertice__000006_Verticle_in_class_diagram_Default_in_middle_between_Default_Restriction_and_Default_Pattern := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-Restriction and Default-Pattern`}).Stage(stage)
	__Vertice__000007_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_ComplexType := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-Schema and Default-ComplexType`}).Stage(stage)
	__Vertice__000008_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_Element := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-Schema and Default-Element`}).Stage(stage)
	__Vertice__000009_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_SimpleType := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-Schema and Default-SimpleType`}).Stage(stage)
	__Vertice__000010_Verticle_in_class_diagram_Default_in_middle_between_Default_Sequence_and_Default_Element := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-Sequence and Default-Element`}).Stage(stage)
	__Vertice__000011_Verticle_in_class_diagram_Default_in_middle_between_Default_SimpleType_and_Default_Restriction := (&models.Vertice{Name: `Verticle in class diagram Default in middle between Default-SimpleType and Default-Restriction`}).Stage(stage)
	...
	//gong:ident [ref_models.Pattern.Value] comment added to overcome the problem with the comment map association
	__Field__000002_Value.Identifier = `ref_models.Pattern.Value`
	__Field__000002_Value.FieldTypeAsString = ``
	__Field__000002_Value.Structname = `Pattern`
	...
	__Field__000003_Value.Identifier = `ref_models.Enumeration.Value`
	__Field__000003_Value.FieldTypeAsString = ``
	__Field__000003_Value.Structname = `Enumeration`
	__Field__000003_Value.Fieldtypename = `string`

	__Field__000004_Value.Name = `Value`

	//gong:ident [ref_models.MaxInclusive.Value] comment added to overcome the problem with the comment map association
	__Field__000004_Value.Identifier = `ref_models.MaxInclusive.Value`
	__Field__000004_Value.FieldTypeAsString = ``
	__Field__000004_Value.Structname = `MaxInclusive`
	__Field__000004_Value.Fieldtypename = `string`

	__Field__000005_Value.Name = `Value`

	//gong:ident [ref_models.MinInclusive.Value] comment added to overcome the problem with the comment map association
	__Field__000005_Value.Identifier = `ref_models.MinInclusive.Value`
	__Field__000005_Value.FieldTypeAsString = ``
	__Field__000005_Value.Structname = `MinInclusive`
	__Field__000005_Value.Fieldtypename = `string`
	...
	__GongStructShape__000003_Default_MaxInclusive.NbInstances = 1
	__GongStructShape__000003_Default_MaxInclusive.Width = 240.000000
	__GongStructShape__000003_Default_MaxInclusive.Height = 78.000000
	...
	__GongStructShape__000004_Default_MinInclusive.NbInstances = 1
	__GongStructShape__000004_Default_MinInclusive.Width = 240.000000
	__GongStructShape__000004_Default_MinInclusive.Height = 78.000000
	__GongStructShape__000004_Default_MinInclusive.IsSelected = false

	__GongStructShape__000005_Default_Pattern.Name = `Default-Pattern`

	//gong:ident [ref_models.Pattern] comment added to overcome the problem with the comment map association
	__GongStructShape__000005_Default_Pattern.Identifier = `ref_models.Pattern`
	__GongStructShape__000005_Default_Pattern.ShowNbInstances = false
	__GongStructShape__000005_Default_Pattern.NbInstances = 0
	__GongStructShape__000005_Default_Pattern.Width = 240.000000
	__GongStructShape__000005_Default_Pattern.Height = 78.000000
	__GongStructShape__000005_Default_Pattern.IsSelected = false

	__GongStructShape__000006_Default_Restriction.Name = `Default-Restriction`

	//gong:ident [ref_models.Restriction] comment added to overcome the problem with the comment map association
	__GongStructShape__000006_Default_Restriction.Identifier = `ref_models.Restriction`
	__GongStructShape__000006_Default_Restriction.ShowNbInstances = false
	__GongStructShape__000006_Default_Restriction.NbInstances = 2
	__GongStructShape__000006_Default_Restriction.Width = 240.000000
	__GongStructShape__000006_Default_Restriction.Height = 78.000000
	__GongStructShape__000006_Default_Restriction.IsSelected = false

	__GongStructShape__000007_Default_Schema.Name = `Default-Schema`

	//gong:ident [ref_models.Schema] comment added to overcome the problem with the comment map association
	__GongStructShape__000007_Default_Schema.Identifier = `ref_models.Schema`
	__GongStructShape__000007_Default_Schema.ShowNbInstances = false
	__GongStructShape__000007_Default_Schema.NbInstances = 1
	__GongStructShape__000007_Default_Schema.Width = 240.000000
	__GongStructShape__000007_Default_Schema.Height = 170.000000
	__GongStructShape__000007_Default_Schema.IsSelected = false

	__GongStructShape__000008_Default_Sequence.Name = `Default-Sequence`

	//gong:ident [ref_models.Sequence] comment added to overcome the problem with the comment map association
	__GongStructShape__000008_Default_Sequence.Identifier = `ref_models.Sequence`
	__GongStructShape__000008_Default_Sequence.ShowNbInstances = false
	__GongStructShape__000008_Default_Sequence.NbInstances = 2
	__GongStructShape__000008_Default_Sequence.Width = 240.000000
	__GongStructShape__000008_Default_Sequence.Height = 63.000000
	__GongStructShape__000008_Default_Sequence.IsSelected = false

	__GongStructShape__000009_Default_SimpleType.Name = `Default-SimpleType`

	//gong:ident [ref_models.SimpleType] comment added to overcome the problem with the comment map association
	__GongStructShape__000009_Default_SimpleType.Identifier = `ref_models.SimpleType`
	__GongStructShape__000009_Default_SimpleType.ShowNbInstances = false
	__GongStructShape__000009_Default_SimpleType.NbInstances = 2
	__GongStructShape__000009_Default_SimpleType.Width = 287.000000
	__GongStructShape__000009_Default_SimpleType.Height = 63.000000
	__GongStructShape__000009_Default_SimpleType.IsSelected = false
	...
	__Link__000002_Elements.EndRatio = 0.296806
	__Link__000002_Elements.CornerOffsetRatio = 1.840687
	...
	__Link__000003_Elements.EndRatio = 0.871806
	...
	__Link__000007_Pattern.Name = `Pattern`

	//gong:ident [ref_models.Restriction.Pattern] comment added to overcome the problem with the comment map association
	__Link__000007_Pattern.Identifier = `ref_models.Restriction.Pattern`

	//gong:ident [ref_models.Pattern] comment added to overcome the problem with the comment map association
	__Link__000007_Pattern.Fieldtypename = `ref_models.Pattern`
	__Link__000007_Pattern.FieldOffsetX = -50.000000
	__Link__000007_Pattern.FieldOffsetY = -16.000000
	__Link__000007_Pattern.TargetMultiplicity = models.ZERO_ONE
	__Link__000007_Pattern.TargetMultiplicityOffsetX = -50.000000
	__Link__000007_Pattern.TargetMultiplicityOffsetY = 16.000000
	__Link__000007_Pattern.SourceMultiplicity = models.MANY
	__Link__000007_Pattern.SourceMultiplicityOffsetX = 10.000000
	__Link__000007_Pattern.SourceMultiplicityOffsetY = -50.000000
	__Link__000007_Pattern.StartOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000007_Pattern.StartRatio = 0.500000
	__Link__000007_Pattern.EndOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000007_Pattern.EndRatio = 0.500000
	__Link__000007_Pattern.CornerOffsetRatio = 1.380000

	__Link__000008_Restriction.Name = `Restriction`

	//gong:ident [ref_models.SimpleType.Restriction] comment added to overcome the problem with the comment map association
	__Link__000008_Restriction.Identifier = `ref_models.SimpleType.Restriction`

	//gong:ident [ref_models.Restriction] comment added to overcome the problem with the comment map association
	__Link__000008_Restriction.Fieldtypename = `ref_models.Restriction`
	__Link__000008_Restriction.FieldOffsetX = -50.000000
	__Link__000008_Restriction.FieldOffsetY = -16.000000
	__Link__000008_Restriction.TargetMultiplicity = models.ZERO_ONE
	__Link__000008_Restriction.TargetMultiplicityOffsetX = -50.000000
	__Link__000008_Restriction.TargetMultiplicityOffsetY = 16.000000
	__Link__000008_Restriction.SourceMultiplicity = models.MANY
	__Link__000008_Restriction.SourceMultiplicityOffsetX = 10.000000
	__Link__000008_Restriction.SourceMultiplicityOffsetY = -50.000000
	__Link__000008_Restriction.StartOrientation = models.ORIENTATION_VERTICAL
	__Link__000008_Restriction.StartRatio = 0.223810
	__Link__000008_Restriction.EndOrientation = models.ORIENTATION_VERTICAL
	__Link__000008_Restriction.EndRatio = 0.196806
	__Link__000008_Restriction.CornerOffsetRatio = -0.495764

	__Link__000009_Sequence.Name = `Sequence`

	//gong:ident [ref_models.ComplexType.Sequence] comment added to overcome the problem with the comment map association
	__Link__000009_Sequence.Identifier = `ref_models.ComplexType.Sequence`

	//gong:ident [ref_models.Sequence] comment added to overcome the problem with the comment map association
	__Link__000009_Sequence.Fieldtypename = `ref_models.Sequence`
	__Link__000009_Sequence.FieldOffsetX = -50.000000
	__Link__000009_Sequence.FieldOffsetY = -16.000000
	__Link__000009_Sequence.TargetMultiplicity = models.ZERO_ONE
	__Link__000009_Sequence.TargetMultiplicityOffsetX = -50.000000
	__Link__000009_Sequence.TargetMultiplicityOffsetY = 16.000000
	__Link__000009_Sequence.SourceMultiplicity = models.MANY
	__Link__000009_Sequence.SourceMultiplicityOffsetX = 10.000000
	__Link__000009_Sequence.SourceMultiplicityOffsetY = -50.000000
	__Link__000009_Sequence.StartOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000009_Sequence.StartRatio = 0.535455
	__Link__000009_Sequence.EndOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000009_Sequence.EndRatio = 0.500000
	__Link__000009_Sequence.CornerOffsetRatio = 1.380000

	__Link__000010_SimpleType.Name = `SimpleType`

	//gong:ident [ref_models.Element.SimpleType] comment added to overcome the problem with the comment map association
	__Link__000010_SimpleType.Identifier = `ref_models.Element.SimpleType`

	//gong:ident [ref_models.SimpleType] comment added to overcome the problem with the comment map association
	__Link__000010_SimpleType.Fieldtypename = `ref_models.SimpleType`
	__Link__000010_SimpleType.FieldOffsetX = -50.000000
	__Link__000010_SimpleType.FieldOffsetY = -16.000000
	__Link__000010_SimpleType.TargetMultiplicity = models.ZERO_ONE
	__Link__000010_SimpleType.TargetMultiplicityOffsetX = -50.000000
	__Link__000010_SimpleType.TargetMultiplicityOffsetY = 16.000000
	__Link__000010_SimpleType.SourceMultiplicity = models.MANY
	__Link__000010_SimpleType.SourceMultiplicityOffsetX = 10.000000
	__Link__000010_SimpleType.SourceMultiplicityOffsetY = -50.000000
	__Link__000010_SimpleType.StartOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000010_SimpleType.StartRatio = 0.431680
	__Link__000010_SimpleType.EndOrientation = models.ORIENTATION_VERTICAL
	__Link__000010_SimpleType.EndRatio = 0.155139
	__Link__000010_SimpleType.CornerOffsetRatio = 0.233098

	__Link__000011_SimpleTypes.Name = `SimpleTypes`

	//gong:ident [ref_models.Schema.SimpleTypes] comment added to overcome the problem with the comment map association
	__Link__000011_SimpleTypes.Identifier = `ref_models.Schema.SimpleTypes`

	//gong:ident [ref_models.SimpleType] comment added to overcome the problem with the comment map association
	__Link__000011_SimpleTypes.Fieldtypename = `ref_models.SimpleType`
	__Link__000011_SimpleTypes.FieldOffsetX = -50.000000
	__Link__000011_SimpleTypes.FieldOffsetY = -16.000000
	__Link__000011_SimpleTypes.TargetMultiplicity = models.MANY
	__Link__000011_SimpleTypes.TargetMultiplicityOffsetX = -50.000000
	__Link__000011_SimpleTypes.TargetMultiplicityOffsetY = 16.000000
	__Link__000011_SimpleTypes.SourceMultiplicity = models.MANY
	__Link__000011_SimpleTypes.SourceMultiplicityOffsetX = 10.000000
	__Link__000011_SimpleTypes.SourceMultiplicityOffsetY = -50.000000
	__Link__000011_SimpleTypes.StartOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000011_SimpleTypes.StartRatio = 0.270058
	__Link__000011_SimpleTypes.EndOrientation = models.ORIENTATION_VERTICAL
	__Link__000011_SimpleTypes.EndRatio = 0.867639
	__Link__000011_SimpleTypes.CornerOffsetRatio = -0.496291
	...
	__Position__000005_Pos_Default_Pattern.X = 1012.000061
	__Position__000005_Pos_Default_Pattern.Y = 396.000000
	__Position__000005_Pos_Default_Pattern.Name = `Pos-Default-Pattern`

	__Position__000006_Pos_Default_Restriction.X = 511.000000
	__Position__000006_Pos_Default_Restriction.Y = 66.000000
	__Position__000006_Pos_Default_Restriction.Name = `Pos-Default-Restriction`

	__Position__000007_Pos_Default_Schema.X = 1386.000061
	__Position__000007_Pos_Default_Schema.Y = 554.000000
	__Position__000007_Pos_Default_Schema.Name = `Pos-Default-Schema`

	__Position__000008_Pos_Default_Sequence.X = 1001.000061
	__Position__000008_Pos_Default_Sequence.Y = 702.000000
	__Position__000008_Pos_Default_Sequence.Name = `Pos-Default-Sequence`

	__Position__000009_Pos_Default_SimpleType.X = 498.000000
	__Position__000009_Pos_Default_SimpleType.Y = 474.000000
	__Position__000009_Pos_Default_SimpleType.Name = `Pos-Default-SimpleType`
	...
	__Vertice__000006_Verticle_in_class_diagram_Default_in_middle_between_Default_Restriction_and_Default_Pattern.X = 1121.500031
	__Vertice__000006_Verticle_in_class_diagram_Default_in_middle_between_Default_Restriction_and_Default_Pattern.Y = 270.000000
	__Vertice__000006_Verticle_in_class_diagram_Default_in_middle_between_Default_Restriction_and_Default_Pattern.Name = `Verticle in class diagram Default in middle between Default-Restriction and Default-Pattern`

	__Vertice__000007_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_ComplexType.X = 536.000000
	__Vertice__000007_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_ComplexType.Y = 239.000000
	__Vertice__000007_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_ComplexType.Name = `Verticle in class diagram Default in middle between Default-Schema and Default-ComplexType`

	__Vertice__000008_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_Element.X = 1076.500031
	__Vertice__000008_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_Element.Y = 427.500000
	__Vertice__000008_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_Element.Name = `Verticle in class diagram Default in middle between Default-Schema and Default-Element`

	__Vertice__000009_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_SimpleType.X = 528.500000
	__Vertice__000009_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_SimpleType.Y = 177.500000
	__Vertice__000009_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_SimpleType.Name = `Verticle in class diagram Default in middle between Default-Schema and Default-SimpleType`

	__Vertice__000010_Verticle_in_class_diagram_Default_in_middle_between_Default_Sequence_and_Default_Element.X = 1119.500031
	__Vertice__000010_Verticle_in_class_diagram_Default_in_middle_between_Default_Sequence_and_Default_Element.Y = 301.500000
	__Vertice__000010_Verticle_in_class_diagram_Default_in_middle_between_Default_Sequence_and_Default_Element.Name = `Verticle in class diagram Default in middle between Default-Sequence and Default-Element`

	__Vertice__000011_Verticle_in_class_diagram_Default_in_middle_between_Default_SimpleType_and_Default_Restriction.X = 1126.000031
	__Vertice__000011_Verticle_in_class_diagram_Default_in_middle_between_Default_SimpleType_and_Default_Restriction.Y = 320.000000
	__Vertice__000011_Verticle_in_class_diagram_Default_in_middle_between_Default_SimpleType_and_Default_Restriction.Name = `Verticle in class diagram Default in middle between Default-SimpleType and Default-Restriction`

	// Setup of pointers
	__Classdiagram__000000_Default.GongStructShapes = append(__Classdiagram__000000_Default.GongStructShapes, __GongStructShape__000007_Default_Schema)
	...
	__Classdiagram__000000_Default.GongStructShapes = append(__Classdiagram__000000_Default.GongStructShapes, __GongStructShape__000009_Default_SimpleType)
	__Classdiagram__000000_Default.GongStructShapes = append(__Classdiagram__000000_Default.GongStructShapes, __GongStructShape__000006_Default_Restriction)
	__Classdiagram__000000_Default.GongStructShapes = append(__Classdiagram__000000_Default.GongStructShapes, __GongStructShape__000008_Default_Sequence)
	...
	__Classdiagram__000000_Default.GongStructShapes = append(__Classdiagram__000000_Default.GongStructShapes, __GongStructShape__000005_Default_Pattern)
	__GongStructShape__000000_Default_ComplexType.Position = __Position__000000_Pos_Default_ComplexType
	__GongStructShape__000000_Default_ComplexType.Links = append(__GongStructShape__000000_Default_ComplexType.Links, __Link__000009_Sequence)
	...
	__GongStructShape__000001_Default_Element.Links = append(__GongStructShape__000001_Default_Element.Links, __Link__000010_SimpleType)
	...
	__GongStructShape__000002_Default_Enumeration.Fields = append(__GongStructShape__000002_Default_Enumeration.Fields, __Field__000003_Value)
	__GongStructShape__000003_Default_MaxInclusive.Position = __Position__000003_Pos_Default_MaxInclusive
	__GongStructShape__000003_Default_MaxInclusive.Fields = append(__GongStructShape__000003_Default_MaxInclusive.Fields, __Field__000004_Value)
	__GongStructShape__000004_Default_MinInclusive.Position = __Position__000004_Pos_Default_MinInclusive
	__GongStructShape__000004_Default_MinInclusive.Fields = append(__GongStructShape__000004_Default_MinInclusive.Fields, __Field__000005_Value)
	__GongStructShape__000005_Default_Pattern.Position = __Position__000005_Pos_Default_Pattern
	__GongStructShape__000005_Default_Pattern.Fields = append(__GongStructShape__000005_Default_Pattern.Fields, __Field__000002_Value)
	__GongStructShape__000006_Default_Restriction.Position = __Position__000006_Pos_Default_Restriction
	__GongStructShape__000006_Default_Restriction.Fields = append(__GongStructShape__000006_Default_Restriction.Fields, __Field__000000_Base)
	__GongStructShape__000006_Default_Restriction.Links = append(__GongStructShape__000006_Default_Restriction.Links, __Link__000004_Enumerations)
	__GongStructShape__000006_Default_Restriction.Links = append(__GongStructShape__000006_Default_Restriction.Links, __Link__000006_MinInclusive)
	__GongStructShape__000006_Default_Restriction.Links = append(__GongStructShape__000006_Default_Restriction.Links, __Link__000005_MaxInclusive)
	__GongStructShape__000006_Default_Restriction.Links = append(__GongStructShape__000006_Default_Restriction.Links, __Link__000007_Pattern)
	__GongStructShape__000007_Default_Schema.Position = __Position__000007_Pos_Default_Schema
	__GongStructShape__000007_Default_Schema.Links = append(__GongStructShape__000007_Default_Schema.Links, __Link__000011_SimpleTypes)
	__GongStructShape__000007_Default_Schema.Links = append(__GongStructShape__000007_Default_Schema.Links, __Link__000001_ComplexTypes)
	__GongStructShape__000007_Default_Schema.Links = append(__GongStructShape__000007_Default_Schema.Links, __Link__000002_Elements)
	__GongStructShape__000008_Default_Sequence.Position = __Position__000008_Pos_Default_Sequence
	__GongStructShape__000008_Default_Sequence.Links = append(__GongStructShape__000008_Default_Sequence.Links, __Link__000003_Elements)
	__GongStructShape__000009_Default_SimpleType.Position = __Position__000009_Pos_Default_SimpleType
	__GongStructShape__000009_Default_SimpleType.Links = append(__GongStructShape__000009_Default_SimpleType.Links, __Link__000008_Restriction)
	...
	__Link__000001_ComplexTypes.Middlevertice = __Vertice__000007_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_ComplexType
	__Link__000002_Elements.Middlevertice = __Vertice__000008_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_Element
	__Link__000003_Elements.Middlevertice = __Vertice__000010_Verticle_in_class_diagram_Default_in_middle_between_Default_Sequence_and_Default_Element
	...
	__Link__000007_Pattern.Middlevertice = __Vertice__000006_Verticle_in_class_diagram_Default_in_middle_between_Default_Restriction_and_Default_Pattern
	__Link__000008_Restriction.Middlevertice = __Vertice__000011_Verticle_in_class_diagram_Default_in_middle_between_Default_SimpleType_and_Default_Restriction
	__Link__000009_Sequence.Middlevertice = __Vertice__000000_Verticle_in_class_diagram_Default_in_middle_between_Default_ComplexType_and_Default_Sequence
	__Link__000010_SimpleType.Middlevertice = __Vertice__000002_Verticle_in_class_diagram_Default_in_middle_between_Default_Element_and_Default_SimpleType
	__Link__000011_SimpleTypes.Middlevertice = __Vertice__000009_Verticle_in_class_diagram_Default_in_middle_between_Default_Schema_and_Default_SimpleType
}
