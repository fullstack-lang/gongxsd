...
import * as alt from '../../projects/alt/src/public-api'

import { AltspecificComponent } from '../../projects/altspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  alt = 'Alt'
  probe = 'Alt Data/Model'
  view = this.alt

  views: string[] = [this.alt, this.probe];
