...
import (
	...
	"github.com/fullstack-lang/gongxsd/alt"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(alt.NgDistNg, "ng-github.com-fullstack-lang-gongxsd-alt/dist/ng-github.com-fullstack-lang-gongxsd-alt/browser")))
