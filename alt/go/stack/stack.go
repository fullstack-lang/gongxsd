...
import (
	...
	"github.com/fullstack-lang/gongxsd/alt/go/fullstack"
	"github.com/fullstack-lang/gongxsd/alt/go/models"
	"github.com/fullstack-lang/gongxsd/alt/go/orm"
	"github.com/fullstack-lang/gongxsd/alt/go/probe"

	alt_go "github.com/fullstack-lang/gongxsd/alt/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "github.com/fullstack-lang/gongxsd/alt/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, alt_go.GoModelsDir, alt_go.GoDiagramsDir,
