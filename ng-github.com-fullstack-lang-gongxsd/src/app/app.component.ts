...
import * as gongxsd from '../../projects/gongxsd/src/public-api'

import { GongxsdspecificComponent } from '../../projects/gongxsdspecific/src/public-api'
...
export class AppComponent implements OnInit {
  ...
  gongxsd = 'Gongxsd'
  probe = 'Gongxsd Data/Model'
  view = this.gongxsd

  views: string[] = [this.gongxsd, this.probe];
